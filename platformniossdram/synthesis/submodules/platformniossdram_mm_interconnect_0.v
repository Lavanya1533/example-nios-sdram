...
module platformniossdram_mm_interconnect_0 (
	...
	wire  [102:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_1_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> pio_2_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // pio_2_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> pio_2_s1_agent:cp_channel
	...
	wire  [102:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [102:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [102:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [102:0] pio_2_s1_agent_rp_data;                                                             // pio_2_s1_agent:rp_data -> router_009:sink_data
	...
	wire    [7:0] router_005_src_channel;                                                             // router_005:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire    [7:0] sdram_s1_rsp_width_adapter_src_channel;                                             // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire    [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	wire    [7:0] rsp_demux_003_src0_channel;                                                         // rsp_demux_003:src0_channel -> crosser_001:in_channel
	...
	wire    [7:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> rsp_mux:sink3_channel
