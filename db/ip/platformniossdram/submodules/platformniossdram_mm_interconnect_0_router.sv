...
(
    ...
    localparam PAD5 = log2ceil(64'h4041050 - 64'h4041040); 
    localparam PAD6 = log2ceil(64'h4041060 - 64'h4041050); 
    localparam PAD7 = log2ceil(64'h4041070 - 64'h4041060); 
    localparam PAD8 = log2ceil(64'h4041078 - 64'h4041070); 
    // -------------------------------------------------------
    ...
    // ( 0x4041040 .. 0x4041050 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 27'h4041040  && read_transaction  ) begin
            src_channel = 9'b010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x4041050 .. 0x4041060 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 27'h4041050   ) begin
            src_channel = 9'b001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x4041060 .. 0x4041070 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h4041060   ) begin
            src_channel = 9'b000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x4041070 .. 0x4041078 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 27'h4041070   ) begin
